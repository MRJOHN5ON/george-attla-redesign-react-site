---
name: clone-website
description: Reverse-engineer and clone websites into this Next.js project — extracts design tokens, assets, and component specs, then builds sections in parallel. Use when the user wants to clone, replicate, rebuild, reverse-engineer, or copy a website, or says /clone-website, pixel-perfect clone, or make a copy of this site. Requires a target URL from the user and browser MCP.
---
